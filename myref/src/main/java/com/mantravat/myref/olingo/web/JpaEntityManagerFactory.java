...
import com.mantravat.myref.jpa.model.util.Utility;
...
public class JpaEntityManagerFactory {
	 ...
	 */
	public static final String DATA_SOURCE_NAME = "java:comp/env/jdbc/TestDB";
	
	/**
	 * The package name which contains all the model classes.
	 */
	public static final String PERSISTENCE_UNIT_NAME = "myref";
